...
from ..models import User, BotSettings, BotCurrentTrade
...
def execute_buy_order(
    ...
    if buy_success:
        ...
        if bot_settings.use_gpt_analysis:
            trade_msg_content += (f"\n\n{bot_settings.gpt_model} analysis explanation:\n{bot_settings.bot_technical_analysis.gpt_analysis.get('explanation', 'No explanation available')}")
