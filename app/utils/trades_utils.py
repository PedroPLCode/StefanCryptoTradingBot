...
def show_account_balance(symbol, account_status, assets_to_include):
    ...
    try:
        ...
        send_admin_email("Exception in show_account_balance", str(e))
        return False
...
def get_balance_for_symbol(account_status, cryptocoin_symbol):
    ...
    try:
        ...
        logger.error(f"Exception in get_balance_for_symbol: {str(e)}")
        send_admin_email("Exception in get_balance_for_symbol", str(e))
        return 0
...
def calculate_profit_percentage(buy_price, sell_price):
    ...
    try:
        ...
        send_admin_email("Exception in calculate_profit_percentage", str(e))
        return "unknown"
