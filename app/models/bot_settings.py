...
class BotSettings(db.Model):
    ...
    avg_volume_period = db.Column(db.Integer, default=5, nullable=False)
    ...
    stock_k_timeperiod = db.Column(db.Integer, default=14, nullable=False)
    ...
    stock_rsi_k_timeperiod = db.Column(db.Integer, default=14, nullable=False)
    stock_rsi_d_timeperiod = db.Column(db.Integer, default=3, nullable=False)
