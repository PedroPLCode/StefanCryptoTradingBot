...
class BotSettings(db.Model):
    ...
    symbol = db.Column(db.String(128), default="BTCUSDC", nullable=True)
    interval = db.Column(db.String(16), default="1h", nullable=True)
    lookback_period = db.Column(db.String(16), default="2d", nullable=True)
    strategy = db.Column(db.String(128), default="rsi + macd", nullable=True)
    comment = db.Column(db.String(1024), default="swing",
                        nullable=True, unique=False)

    capital_utilization_pct = db.Column(db.Float, default=0.95, nullable=True)
    selected_plot_indicators = db.Column(
        db.JSON, default=['rsi', 'macd'], nullable=True)
    days_period_to_clean_history = db.Column(
        db.Integer, default=30, nullable=True)
    ...
    use_technical_analysis = db.Column(
        db.Boolean, default=False, nullable=True)
    use_machine_learning = db.Column(db.Boolean, default=False, nullable=True)
    ...
    cycles_of_suspension_after_negative_trade = db.Column(
        db.Integer, default=8, nullable=True)
    suspension_cycles_remaining = db.Column(
        db.Integer, default=0, nullable=True)

    use_stop_loss = db.Column(db.Boolean, default=True, nullable=True)
    use_trailing_stop_loss = db.Column(
        db.Boolean, default=False, nullable=True)
    stop_loss_pct = db.Column(db.Float, default=0.02, nullable=True)
    trailing_stop_with_atr = db.Column(
        db.Boolean, default=False, nullable=True)
    trailing_stop_atr_calc = db.Column(db.Float, default=1, nullable=True)

    use_take_profit = db.Column(db.Boolean, default=True, nullable=True)
    use_trailing_take_profit = db.Column(
        db.Boolean, default=True, nullable=True)
    take_profit_pct = db.Column(db.Float, default=0.03, nullable=True)
    take_profit_with_atr = db.Column(db.Boolean, default=False, nullable=True)
    take_profit_atr_calc = db.Column(db.Float, default=3, nullable=True)

    trend_signals = db.Column(db.Boolean, default=False, nullable=True)
    rsi_signals = db.Column(db.Boolean, default=True, nullable=True)
    rsi_divergence_signals = db.Column(
        db.Boolean, default=False, nullable=True)
    vol_signals = db.Column(db.Boolean, default=True, nullable=True)
    macd_cross_signals = db.Column(db.Boolean, default=True, nullable=True)
    macd_histogram_signals = db.Column(
        db.Boolean, default=False, nullable=True)
    bollinger_signals = db.Column(db.Boolean, default=True, nullable=True)
    stoch_signals = db.Column(db.Boolean, default=True, nullable=True)
    stoch_divergence_signals = db.Column(
        db.Boolean, default=False, nullable=True)
    stoch_rsi_signals = db.Column(db.Boolean, default=False, nullable=True)
    ema_cross_signals = db.Column(db.Boolean, default=False, nullable=True)
    ema_fast_signals = db.Column(db.Boolean, default=False, nullable=True)
    ema_slow_signals = db.Column(db.Boolean, default=False, nullable=True)
    di_signals = db.Column(db.Boolean, default=False, nullable=True)
    cci_signals = db.Column(db.Boolean, default=False, nullable=True)
    cci_divergence_signals = db.Column(
        db.Boolean, default=False, nullable=True)
    mfi_signals = db.Column(db.Boolean, default=False, nullable=True)
    mfi_divergence_signals = db.Column(
        db.Boolean, default=False, nullable=True)
    atr_signals = db.Column(db.Boolean, default=False, nullable=True)
    vwap_signals = db.Column(db.Boolean, default=False, nullable=True)
    psar_signals = db.Column(db.Boolean, default=False, nullable=True)
    ma50_signals = db.Column(db.Boolean, default=False, nullable=True)
    ma200_signals = db.Column(db.Boolean, default=False, nullable=True)
    ma_cross_signals = db.Column(db.Boolean, default=False, nullable=True)

    general_timeperiod = db.Column(db.Integer, default=14, nullable=True)
    di_timeperiod = db.Column(db.Integer, default=14, nullable=True)
    adx_timeperiod = db.Column(db.Integer, default=14, nullable=True)
    rsi_timeperiod = db.Column(db.Integer, default=14, nullable=True)
    atr_timeperiod = db.Column(db.Integer, default=14, nullable=True)
    cci_timeperiod = db.Column(db.Integer, default=20, nullable=True)
    mfi_timeperiod = db.Column(db.Integer, default=14, nullable=True)
    macd_timeperiod = db.Column(db.Integer, default=12, nullable=True)
    macd_signalperiod = db.Column(db.Integer, default=9, nullable=True)
    bollinger_timeperiod = db.Column(db.Integer, default=20, nullable=True)
    bollinger_nbdev = db.Column(db.Integer, default=2, nullable=True)
    stoch_k_timeperiod = db.Column(db.Integer, default=14, nullable=True)
    stoch_d_timeperiod = db.Column(db.Integer, default=3, nullable=True)
    stoch_rsi_timeperiod = db.Column(db.Integer, default=14, nullable=True)
    stoch_rsi_k_timeperiod = db.Column(db.Integer, default=3, nullable=True)
    stoch_rsi_d_timeperiod = db.Column(db.Integer, default=3, nullable=True)
    ema_fast_timeperiod = db.Column(db.Integer, default=9, nullable=True)
    ema_slow_timeperiod = db.Column(db.Integer, default=21, nullable=True)
    psar_acceleration = db.Column(db.Float, default=0.02, nullable=True)
    psar_maximum = db.Column(db.Float, default=0.2, nullable=True)

    cci_buy = db.Column(db.Integer, default=-100, nullable=True)
    cci_sell = db.Column(db.Integer, default=100, nullable=True)
    rsi_buy = db.Column(db.Integer, default=30, nullable=True)
    rsi_sell = db.Column(db.Integer, default=70, nullable=True)
    mfi_buy = db.Column(db.Integer, default=20, nullable=True)
    mfi_sell = db.Column(db.Integer, default=80, nullable=True)
    stoch_buy = db.Column(db.Integer, default=20, nullable=True)
    stoch_sell = db.Column(db.Integer, default=80, nullable=True)
    atr_buy_treshold = db.Column(db.Float, default=0.005, nullable=True)

    avg_volume_period = db.Column(db.Integer, default=1, nullable=True)
    avg_close_period = db.Column(db.Integer, default=3, nullable=True)
    avg_adx_period = db.Column(db.Integer, default=7, nullable=True)
    avg_atr_period = db.Column(db.Integer, default=28, nullable=True)
    avg_di_period = db.Column(db.Integer, default=7, nullable=True)
    avg_rsi_period = db.Column(db.Integer, default=1, nullable=True)
    avg_stoch_rsi_period = db.Column(db.Integer, default=1, nullable=True)
    avg_macd_period = db.Column(db.Integer, default=1, nullable=True)
    avg_stoch_period = db.Column(db.Integer, default=1, nullable=True)
    avg_ema_period = db.Column(db.Integer, default=1, nullable=True)
    avg_cci_period = db.Column(db.Integer, default=1, nullable=True)
    avg_mfi_period = db.Column(db.Integer, default=1, nullable=True)
    avg_psar_period = db.Column(db.Integer, default=1, nullable=True)
    avg_vwap_period = db.Column(db.Integer, default=1, nullable=True)

    adx_strong_trend = db.Column(db.Integer, default=25, nullable=True)
    adx_weak_trend = db.Column(db.Integer, default=20, nullable=True)
    adx_no_trend = db.Column(db.Integer, default=5, nullable=True)

    ml_general_timeperiod = db.Column(db.Integer, default=14, nullable=True)
    ml_macd_timeperiod = db.Column(db.Integer, default=12, nullable=True)
    ml_macd_signalperiod = db.Column(db.Integer, default=9, nullable=True)
    ml_bollinger_timeperiod = db.Column(db.Integer, default=20, nullable=True)
    ml_bollinger_nbdev = db.Column(db.Integer, default=2, nullable=True)
    ml_ema_fast_timeperiod = db.Column(db.Integer, default=9, nullable=True)
    ml_ema_slow_timeperiod = db.Column(db.Integer, default=21, nullable=True)
    ml_rsi_buy = db.Column(db.Integer, default=30, nullable=True)
    ml_rsi_sell = db.Column(db.Integer, default=70, nullable=True)
    ml_lag_period = db.Column(db.Integer, default=7, nullable=True)

    ml_use_random_forest_model = db.Column(
        db.Boolean, default=True, nullable=True)
    ml_random_forest_model_filename = db.Column(
        db.String(128), default="model_btc_1h_random_forest.joblib", nullable=True)
    ml_random_forest_predictions_avg = db.Column(
        db.Integer, default=1, nullable=True)
    ml_random_forest_buy_trigger_pct = db.Column(
        db.Float, default=3, nullable=True)
    ml_random_forest_sell_trigger_pct = db.Column(
        db.Float, default=-2, nullable=True)

    ml_use_xgboost_model = db.Column(db.Boolean, default=True, nullable=True)
    ml_xgboost_model_filename = db.Column(
        db.String(128), default="model_btc_1h_xgboost.model", nullable=True)
    ml_xgboost_predictions_avg = db.Column(
        db.Integer, default=1, nullable=True)
    ml_xgboost_buy_trigger_pct = db.Column(db.Float, default=3, nullable=True)
    ml_xgboost_sell_trigger_pct = db.Column(
        db.Float, default=-2, nullable=True)

    ml_use_lstm_model = db.Column(db.Boolean, default=True, nullable=True)
    ml_lstm_window_size = db.Column(db.Integer, default=30, nullable=True)
    ml_lstm_window_lookback = db.Column(db.Integer, default=14, nullable=True)
    ml_lstm_model_filename = db.Column(
        db.String(128), default="model_btc_1h_lstm.keras", nullable=True)
    ml_lstm_predictions_avg = db.Column(db.Integer, default=1, nullable=True)
    ml_lstm_buy_trigger_pct = db.Column(db.Float, default=3, nullable=True)
    ml_lstm_sell_trigger_pct = db.Column(db.Float, default=-2, nullable=True)
    ...
    gpt_prompt_with_last_trades = db.Column(db.Boolean, default=True, nullable=True)
    last_trades_limit = db.Column(db.Integer, default=5, nullable=True)
    ...
    etop_passwd = db.Column(db.String(1024), default="estop_password", nullable=True)
