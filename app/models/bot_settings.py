...
class BotSettings(db.Model):
    ...
    ml_stoch_k_timeperiod = db.Column(db.Integer, default=14, nullable=False)
    ml_stoch_d_timeperiod = db.Column(db.Integer, default=3, nullable=False)
    ml_stoch_rsi_k_timeperiod = db.Column(db.Integer, default=14, nullable=False)
    ml_stoch_rsi_d_timeperiod = db.Column(db.Integer, default=3, nullable=False)
    ...
    ml_psar_acceleration = db.Column(db.Float, default=0.02, nullable=False)
    ml_psar_maximum = db.Column(db.Float, default=0.2, nullable=False)
    
    ml_lag_min = db.Column(db.Integer, default=1, nullable=False)
    ml_lag_max = db.Column(db.Integer, default=7, nullable=False)
