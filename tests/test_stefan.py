...
def test_run_trading_logic_buy(mock_logger, mock_save_previous_price, mock_save_trailing_stop_loss,
                                mock_load_current_trade, mock_place_sell_order,
...
@patch('test_app.stefan.stefan.save_previous_price')
@patch('test_app.stefan.stefan.logger')
def test_run_trading_logic_sell(mock_logger, mock_save_previous_price, mock_save_trailing_stop_loss,
                                 mock_load_current_trade, mock_place_buy_order,
